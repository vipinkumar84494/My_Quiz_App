...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionsList = QuizData.getQuestions()
        // END
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        ...
                        mCurrentPosition <= mQuestionsList!!.size -> {
                           ...
                           val intent1 = intent
                            val name:String? = intent1.getStringExtra("myname")
                            val intent = Intent(this,ResultActivity::class.java)
                            intent.putExtra("mCorrectAnswers",mCorrectAnswers.toString())
                            Log.e("jldjlaj",name!!)
                    ...
                    if (question!!.currectAns != mSelectedOptionPosition) {
                    ...
                    answerView(question.currectAns, R.drawable.correct_option_border_bg)
